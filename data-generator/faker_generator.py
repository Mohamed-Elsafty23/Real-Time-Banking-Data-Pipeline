"""
Synthetic core-banking workload: customers, accounts, and transactions into Postgres OLTP.

Run continuously by default, or `python faker_generator.py --once` for a single batch.
"""
import time
import psycopg2
